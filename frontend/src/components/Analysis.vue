...
function removeCase(i: number) {
    if (project.analysis.Cases.length > 1) {
        project.removeAnalysisCase(caseID.value)
        caseID.value = 1
    }
}
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <select class="form-select" id="selectedCase" v-model="caseID">
                    ...
                    <div class="col-2 d-grid">
                        <button class="btn btn-danger" @click="removeCase(caseID)"
                            :disabled="project.analysis.Cases.length < 2">Remove</button>
                    </div>
                </div>
            </div>
            <hr class="my-0" />
            <div class="card-body">
                <Case :Case="project.analysis.Cases[caseID - 1]" />
            </div>
        </div>
    </main>
</template>
