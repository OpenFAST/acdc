...
var SubDyn = NewFile("SubDyn", []Field{
	{Type: Heading, Desc: "SubDyn Input File"},
	...
	{Type: Heading, Desc: `Fea And Craig-Bampton Parameters`},
	...
	{Name: "JDampings", Type: Floats, Num: "Nmodes", Desc: `Damping Ratios for each retained mode (% of critical) If Nmodes>0, list Nmodes structural damping ratios for each retained mode (% of critical), or a single damping ratio to be applied to all retained modes. (last entered value will be used for all remaining modes).`},
	{Name: "GuyanDampMod", Type: Int, Desc: `Guyan damping {0=none, 1=Rayleigh Damping, 2=user specified 6x6 matrix}`},
	{Name: "RayleighDamp", Type: Floats, Num: "2", Desc: `Mass and stiffness proportional damping  coefficients (Rayleigh Damping) [only if GuyanDampMod=1]`},
	{Name: "GuyanDampSize", Type: Int, Desc: `Guyan damping matrix (6x6) [only if GuyanDampMod=2]`},
	{Name: "GuyanDampMatrix", Type: Table, Num: "GuyanDampSize",
		TableHeaderSize: 0,
		TableColumns: []Column{
			{Name: "C1", Type: Float},
			{Name: "C2", Type: Float},
	...
	{Type: Heading, Desc: `STRUCTURE JOINTS: joints connect structure members (~Hydrodyn Input File)`},
	{Name: "NJoints", Type: Int, Desc: `Number of joints`},
	{Name: "Joints", Type: Table, Num: "NJoints",
		TableHeaderSize: 2,
		TableColumns: []Column{
	...
	{Type: Heading, Desc: `Base Reaction Joints: 1/0 For Locked/Free Dof @ Each Reaction Node `},
	...
	{Name: "React", Type: Table, Num: "NReact",
		TableHeaderSize: 2,
		TableColumns: []Column{
	...
	{Type: Heading, Desc: `INTERFACE JOINTS: 1/0 for Locked (to the TP)/Free DOF @each Interface Joint (only Locked-to-TP implemented thus far (=rigid TP))`},
	...
	{Name: "Members", Type: Table, Num: "NMembers",
		TableHeaderSize: 2,
		TableColumns: []Column{
	...
	{Type: Heading, Desc: `Member X-Section Property Data 1/2 [Isotropic Material For Now: Use This Table For Circular-Tubular Elements] `},
	...
	{Name: "PropSets", Type: Table, Num: "NPropSets",
		TableHeaderSize: 2,
		TableColumns: []Column{
	...
	{Type: Heading, Desc: `Member X-Section Property Data 2/2 [Isotropic Material For Now: Use This Table If Any Section Other Than Circular, However Provide Cosm(I,J) Below] `},
	{Name: "NXPropSets", Type: Int, Desc: `Number of structurally unique non-circular x-sections (if 0 the following table is ignored)`},
	{Name: "XPropSets", Type: Table, Num: "NXPropSets",
		TableHeaderSize: 2,
		TableColumns: []Column{
	...
	{Type: Heading, Desc: `Cable Properties  `},
	{Name: "NCablePropSets", Type: Int, Desc: `Number of cable cable properties`},
	{Name: "CablePropSets", Type: Table, Num: "NCablePropSets",
		TableHeaderSize: 2,
		TableColumns: []Column{
			{Name: "PropSetID", Type: Int, Unit: "-"},
	...
	{Type: Heading, Desc: `Rigid Link Properties `},
	{Name: "NRigidPropSets", Type: Int, Desc: `Number of rigid link properties`},
	{Name: "RigidPropSets", Type: Table, Num: "NRigidPropSets",
		TableHeaderSize: 2,
		TableColumns: []Column{
			{Name: "PropSetID", Type: Int, Unit: "-"},
			{Name: "EA", Type: Float, Unit: "N"},
	...
	{Type: Heading, Desc: `Member Cosine Matrices Cosm(I,J) `},
	...
	{Name: "COSMs", Type: Table, Num: "NCOSMs",
		TableHeaderSize: 2,
		TableColumns: []Column{
			{Name: "COSMID", Type: Int, Unit: "-"},
	...
	{Type: Heading, Desc: `Output: Summary & Outfile `},
	...
	{Name: "MOutputs", Type: Table, Num: "NMOutputs",
		TableHeaderSize: 2,
		TableColumns: []Column{
			{Name: "MemberID", Type: Int, Unit: "-"},
	...
	{Type: Heading, Desc: `SSOutList: The next line(s) contains a list of output parameters that will be output in <rootname>.SD.out or <rootname>.out.`},
