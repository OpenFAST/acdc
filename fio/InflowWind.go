...
var InflowWind = NewFile("InflowWind", []Field{
	{Type: Heading, Desc: "InflowWind Input File"},
	{Name: "Title", Type: Title},
	{Type: Heading, Desc: "General"},
	...
	{Name: "WindVxiList", Type: Floats, Num: "NWindVel", Desc: `List of coordinates in the inertial X direction (m)`},
	{Name: "WindVyiList", Type: Floats, Num: "NWindVel", Desc: `List of coordinates in the inertial Y direction (m)`},
	{Name: "WindVziList", Type: Floats, Num: "NWindVel", Desc: `List of coordinates in the inertial Z direction (m)`},
	{Type: Heading, Desc: `Parameters for Steady Wind Conditions [used only for WindType = 1]`},
	...
	{Type: Heading, Desc: `Parameters for Uniform wind file   [used only for WindType = 2]`},
	{Name: "Filename_Uni", Type: Path, Desc: `Filename of time series data for uniform wind field`,
		PathFileType: "UniformWind"},
	...
	{Type: Heading, Desc: `Parameters for Binary TurbSim Full-Field files   [used only for WindType = 3]`},
	{Name: "FileName_BTS", Type: Path, Desc: `Name of the Full field wind file to use (.bts)`},
	{Type: Heading, Desc: `Parameters for Binary Bladed-style Full-Field files   [used only for WindType = 4 or WindType = 7]`},
	...
	{Type: Heading, Desc: `Parameters for HAWC-format binary files  [Only used with WindType = 5]`},
	...
	{Type: Heading, Desc: `Scaling parameters for turbulence`},
	...
	{Type: Heading, Desc: `Mean wind profile parameters (added to HAWC-format files)`},
