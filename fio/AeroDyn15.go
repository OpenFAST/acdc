...
var AeroDyn15 = NewFile("AeroDyn15", []Field{
	{Type: Heading, Desc: "AeroDyn15 Input File"},
	{Name: "Title", Type: Title},
	{Type: Heading, Desc: "General Options"},
	...
	{Type: Heading, Desc: `Blade-Element/Momentum Theory Options [unused when WakeMod=0 or 3]`},
	...
	{Type: Heading, Desc: `Dynamic Blade-Element/Momentum Theory Options [used only when WakeMod=2]`},
	...
	{Type: Heading, Desc: `OLAF -- cOnvecting LAgrangian Filaments (Free Vortex Wake) Theory Options [used only when WakeMod=3]`},
	{Name: "OLAFInputFileName", Type: Path, Desc: `Input file for OLAF [used only when WakeMod=3]`,
		PathFileType: "FreeVortexWake"},
	{Type: Heading, Desc: `Beddoes-Leishman Unsteady Airfoil Aerodynamics Options [used only when AFAeroMod=2]`},
	...
	{Type: Heading, Desc: `Airfoil Information`},
	...
	{Name: "AFNames", Type: Paths, Num: "NumAFfiles", Desc: `Airfoil file names`, Unit: "quoted strings",
		PathFileType: "AirfoilInfo"},
	{Type: Heading, Desc: `Rotor/Blade Properties`},
	{Name: "UseBlCm", Type: Bool, Desc: `Include aerodynamic pitching moment in calculations?`, Unit: "flag"},
	{Name: "ADBlFile(1)", Type: Path, Desc: `Name of file containing distributed aerodynamic properties for Blade #1`,
		PathFileType: "AeroDynBlade"},
	{Name: "ADBlFile(2)", Type: Path, Desc: `Name of file containing distributed aerodynamic properties for Blade #2 [unused if NumBl < 2]`,
		PathFileType: "AeroDynBlade"},
	{Name: "ADBlFile(3)", Type: Path, Desc: `Name of file containing distributed aerodynamic properties for Blade #3 [unused if NumBl < 3]`,
		PathFileType: "AeroDynBlade"},
	{Type: Heading, Desc: `Hub Properties [used only when Buoyancy=True]`},
	{Name: "VolHub", Type: Float, Desc: `Hub volume (m^3)`},
	{Name: "HubCenBx", Type: Float, Desc: `Hub center of buoyancy x direction offset (m)`},
	{Type: Heading, Desc: `Nacelle Properties [used only when Buoyancy=True]`},
	{Name: "VolNac", Type: Float, Desc: `Nacelle volume`, Unit: "m^3"},
	{Name: "NacCenB", Type: Floats, Num: "3", Desc: `Position of nacelle center of buoyancy from yaw bearing in nacelle coordinates`, Unit: "m"},
	{Type: Heading, Desc: `Tail fin Aerodynamics`},
	...
	{Name: "TFinFile", Type: Path, Desc: `Input file for tail fin aerodynamics [used only when TFinAero=True]`,
		PathFileType: "TailFin"},
	{Type: Heading, Desc: `Tower Influence and Aerodynamics [used only when TwrPotent/=0, TwrShadow/=0, TwrAero=True, or Buoyancy=True]`},
	...
	{Name: "TwrNd", Type: Table, Num: "NumTwrNds",
		TableHeaderSize: 2,
		TableColumns: []Column{
	...
	{Name: "BlOutNd", Type: Ints, Num: "NBlOuts", Desc: `Blade nodes whose values will be output`},
	{Name: "NTwOuts", Type: Int, Desc: `Number of tower node outputs [0 - 9]`},
	{Name: "TwOutNd", Type: Ints, Num: "NTwOuts", Desc: `Tower nodes whose values will be output`},
