...
var Main = RegisterSchemas("Main", []Schema{
	{Type: Header, Desc: "OpenFAST Input File"},
	...
	{Type: Header, Desc: "Feature switches and flags"},
	...
	{Type: Header, Desc: `Input Files`},
	{Name: "EDFile", Type: File, FileType: "ElastoDyn", Desc: `Name of file containing ElastoDyn input parameters`, Unit: "quoted string"},
	{Name: "BDBldFile(1)", Type: File, FileType: "BeamDyn", Desc: `Name of file containing BeamDyn input parameters for blade 1`, Unit: "quoted string"},
	{Name: "BDBldFile(2)", Type: File, FileType: "BeamDyn", Desc: `Name of file containing BeamDyn input parameters for blade 2`, Unit: "quoted string"},
	{Name: "BDBldFile(3)", Type: File, FileType: "BeamDyn", Desc: `Name of file containing BeamDyn input parameters for blade 3`, Unit: "quoted string"},
	{Name: "InflowFile", Type: File, FileType: "InflowWind", Desc: `Name of file containing inflow wind input parameters`, Unit: "quoted string"},
	{Name: "AeroFile", Type: File, FileType: "", Desc: `Name of file containing aerodynamic input parameters`, Unit: "quoted string"},
	{Name: "ServoFile", Type: File, FileType: "ServoDyn", Desc: `Name of file containing control and electrical-drive input parameters`, Unit: "quoted string"},
	{Name: "HydroFile", Type: Path, FileType: "HydroDyn", Desc: `Name of file containing hydrodynamic input parameters`, Unit: "quoted string"},
	{Name: "SubFile", Type: File, FileType: "SubDyn", Desc: `Name of file containing sub-structural input parameters`, Unit: "quoted string"},
	{Name: "MooringFile", Type: Path, FileType: "", Desc: `Name of file containing mooring system input parameters`, Unit: "quoted string"},
	{Name: "IceFile", Type: Path, FileType: "", Desc: `Name of file containing ice input parameters`, Unit: "quoted string"},
	...
	{Type: Header, Desc: `Linearization`},
	...
	{Name: "LinTimes", Type: Floats, NumVar: "NLinTimes", Desc: `List of times at which to linearize [1 to NLinTimes] [used only when Linearize=True and CalcSteady=False]`, Unit: "sec"},
	...
	{Type: Header, Desc: `Visualization`},
